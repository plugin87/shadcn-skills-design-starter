...
## Steps
1. Read `.claude/skills/_ux-ui-shared/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`.claude/skills/_ux-ui-shared/tokens/*`), components (`.claude/skills/_ux-ui-shared/components/*`), taste (`.claude/skills/_ux-ui-shared/taste/*`), and a11y (`.claude/skills/_ux-ui-shared/accessibility/*`).

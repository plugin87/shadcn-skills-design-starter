// Pull design data from Figma via the OFFICIAL REST API.
// No app patching, no CDP, no rate-limited MCP tool calls — just the sanctioned
// REST endpoints with a Personal Access Token.
//
// Usage:
//   node scripts/figma-pull.mjs <nodeId> [nodeId ...]
//   node scripts/figma-pull.mjs 72-2591 308-14
//   node scripts/figma-pull.mjs --file <KEY> --out report.json 72-2591
//
...
//
// File key:  $FIGMA_FILE_KEY, or --file <KEY>, else the project default below.
...
const DEFAULT_FILE_KEY = "s1RUIz6zs7ZHPvChvkg9XC"
...
async function main() {
  ...
  const fileKey = opts.file ?? process.env.FIGMA_FILE_KEY ?? DEFAULT_FILE_KEY
